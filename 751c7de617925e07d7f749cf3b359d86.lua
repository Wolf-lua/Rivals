...
local Window = Rayfield:CreateWindow({
    Name = "Wolf Scripte - FREE | .gg/5YCGUJVB5b",
    Icon = 0, -- Icon in Topbar. Can use Lucide Icons (string) or Roblox Image (number). 0 to use no icon (default).
    LoadingTitle = "Calme Toi",
    LoadingSubtitle = "by @SpyderGersda |",
    ...
    Discord = {
       ...
       Invite = "5YCGUJVB5b", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ ABCD would be ABCD
    ...
    KeySettings = {
       Title = "Untitled",
       Subtitle = "Key System",
       Note = "Key Get : rkns.link/ibpk2", -- Use this to tell the user how to get a key
